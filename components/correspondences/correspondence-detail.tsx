      ...
      <Tabs defaultValue="overview" className="space-y-6">
        ...
        <TabsContent value="requests" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {mockCorrespondence.requests.map((request, index) => {
                  ...
                  return (
                    <Link key={request.id} href={`/communications/requests/${request.id}`}>
                      <div
                        className={`p-4 border-l-4 ${borderColors[colorIndex]} ${bgColors[colorIndex]} rounded cursor-pointer hover:shadow-md transition-all`}
                      >
        ...
        <TabsContent value="documents" className="space-y-4">
          <Card>
            ...
            <CardContent>
              <div className="space-y-3">
                {mockCorrespondence.documents.map((doc, index) => {
                  const bgColors = ['bg-blue-50', 'bg-green-50', 'bg-purple-50', 'bg-red-50']
                  const borderColors = ['border-blue-500', 'border-green-500', 'border-purple-500', 'border-red-500']
                  const colorIndex = index % 4
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {mockCorrespondence.comments.map((comment, index) => {
                  const bgColors = ['bg-blue-50', 'bg-green-50', 'bg-purple-50', 'bg-red-50']
                  const borderColors = ['border-blue-500', 'border-green-500', 'border-purple-500', 'border-red-500']
                  const colorIndex = index % 4
